...
import { FiLinkedin, FiFacebook, FiGithub, FiTwitter } from 'react-icons/fi';
    ...
    <div className="hero relative -mt-16 flex items-center justify-center">
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="mt-4  flex gap-5">
          <Link href="https://www.linkedin.com/in/rajesh-janyani" target="_blank">
            <a className="text-gray-500 transition-colors duration-150 hover:text-primary-500" target="_blank">
              <FiLinkedin size={25} />
            </a>
          </Link>
          {/* <Link href="https://www.twitter.com">
            <a className="text-gray-500 transition-colors duration-150 hover:text-primary-500">
              <FiTwitter size={25} />
            </a>
          </Link> */}
        ...
        <Link href="https://github.com/Rajesh7rj" target="_blank">
          <a className="text-gray-500 transition-colors duration-150 hover:text-primary-500" target="_blank">
            <FiGithub size={25} />
          </a>
        </Link>
